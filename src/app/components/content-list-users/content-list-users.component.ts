...
@Component({
  selector: 'app-content-list-users',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './content-list-users.component.html',
  styleUrl: './content-list-users.component.scss'
})
export class ContentListUsersComponent {
